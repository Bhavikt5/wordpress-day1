...
<html lang="en-US">
	...
	<title>Log In &lsaquo; dayone &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="/wp-admin/css/login.min.css?ver=6.2" media="all">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://localhost/dayone/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="http://localhost/dayone/wp-admin/">
...
<script id="wp-util-js-extra">var _wpUtilSettings = {"ajax":{"url":"\/dayone\/wp-admin\/admin-ajax.php"}};</script>
<script src="/wp-includes/js/wp-util.min.js?ver=6.2" id="wp-util-js"></script>
<script id="user-profile-js-extra">var userProfileL10n = {"user_id":"0","nonce":"5f07014516"};</script>
